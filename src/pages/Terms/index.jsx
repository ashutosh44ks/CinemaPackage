    ...
    <div>
      <div>
        ...
        <section className="my-8">
          <Heading level={4} fontWeight="medium" className="mb-2">
        ...
        <section className="my-8">
          <Heading level={4} fontWeight="medium" className="mb-2">
            Sure, Give Us All Your Info <i>(We Promise Not to Sell It... Maybe)</i>
          </Heading>
          <p>
      ...
      <div>
        ...
        <section className="my-8">
          ...
          <ul className="list-disc pl-4 mt-2">
            <li>
              <span className="font-medium">What information do we collect?</span> We might gather some basic
              stuff like your email address if you sign up for updates (those
              award-worthy recommendations, of course!). We might also see some
              anonymous data about the movies you browse - you know, for
              &quot;research purposes&quot; (a.k.a. figuring out which SRK movies are most popular).
            </li>
            <li>
              <span className="font-medium">What do we do with your information?</span> Honestly, not much! We
              might use your email to send you those movie updates (the good
              stuff, we promise). The anonymous data helps us improve the site
              and, let&apos;s be honest, fuel our never-ending movie trivia
              nights.
            </li>
            <li>
              <span className="font-medium">Do we share your information?</span> Sharing is caring, right? But
              not really. We won&apos;t sell or trade your information with
              anyone, unless, you know, aliens invade and they really need to
              know your favorite superhero flick (doubtful, but hey, gotta cover
              our bases).
            </li>
          </ul>
          <p className="mt-4">
            <span className="font-medium">Look, we get it - privacy is kind of a big deal these days.</span> But
            trust us, we&apos;re more interested in recommending your next
          ...
          <p className="mt-2">
            <span className="font-medium">By using this site, you agree to this privacy policy.</span> Basically,
            you&apos;re cool with us knowing a little bit about your movie
            obsession. Don&apos;t worry, your therapist is safe (probably).
          </p>
          <p className="mt-4">
            <span className="font-medium">P.S.</span> If you have any questions about this privacy policy, feel
            free to reach out. We might even throw in a free popcorn recipe
