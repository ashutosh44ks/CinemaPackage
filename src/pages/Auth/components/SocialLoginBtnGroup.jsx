  ...
  return (
    <div>
      <Button
        ...
        onClick={() => {
          window.open(
            import.meta.env.VITE_APP_BASE_API_URL + "user/auth/google",
            "_self"
          );
        }}
      >
      ...
      <Button
        ...
        onClick={() => {
          window.open(
            import.meta.env.VITE_APP_BASE_API_URL + "auth/facenook",
            "_self"
          );
        }}
      >
      ...
      <Button
        ...
        onClick={() => {
          window.open(
            import.meta.env.VITE_APP_BASE_API_URL + "auth/apple",
            "_self"
          );
        }}
      >
        <AiFillApple size={20} className="hide-on-sm-devices" /> Continue with
        Apple
      </Button>
    </div>
  );
